...
import org.pdf4j.saxon.evpull.EmptyEventIterator;
import org.pdf4j.saxon.evpull.EventIterator;
import org.pdf4j.saxon.evpull.EventIteratorOverSequence;
import org.pdf4j.saxon.evpull.SingletonEventIterator;
...
//    }
     ...
     *
     * @exception org.pdf4j.saxon.trans.XPathException if an error is discovered during expression
     *     rewriting
     ...
     * @exception org.pdf4j.saxon.trans.XPathException if any error is detected
...
//        }
     ...
     * @exception org.pdf4j.saxon.trans.XPathException if any dynamic error occurs evaluating the
     *     expression
     ...
     *
     * <p>The events (of class {@link org.pdf4j.saxon.evpull.PullEvent}) are either complete
...
//    }
     ...
     * @return the type of expression, as enumerated in class {@link org.pdf4j.saxon.trace.Location}
     */
