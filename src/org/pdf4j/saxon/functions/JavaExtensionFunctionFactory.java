...
public class JavaExtensionFunctionFactory implements ExtensionFunctionFactory, Serializable {
    ...
    public Expression makeExtensionFunctionCall(
        StructuredQName functionName, Class theClass, AccessibleObject method, Expression[] arguments) {
