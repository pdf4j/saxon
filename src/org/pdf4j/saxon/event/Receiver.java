...
public interface Receiver extends Result {
    ...
    */
     ...
     * @param locationId an integer which can be interpreted using a {@link org.pdf4j.saxon.event.LocationProvider} to return
     ...
     * properties, zero is supplied. The definitions of the bits are in class {@link org.pdf4j.saxon.event.ReceiverOptions}
     */
    ...
    */
     ...
     * @param locationId an integer which can be interpreted using a {@link org.pdf4j.saxon.event.LocationProvider}
