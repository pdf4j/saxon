...
import org.pdf4j.saxon.StandardURIResolver;
import org.pdf4j.saxon.om.ProcInstParser;
...
public class PIGrabber extends ProxyReceiver {
    ...
    * @throws org.pdf4j.saxon.trans.XPathException if a URI cannot be resolved
    */
