...
* type, that is xs:anyType
    ...
    * @throws org.pdf4j.saxon.trans.XPathException if there is no start tag to write to (created using writeStartTag),
    ...
    * @throws org.pdf4j.saxon.trans.XPathException for any failure
    */
