...
import org.pdf4j.saxon.instruct.ValueOf;
...
public class DotNetExternalObjectType implements AtomicType, Serializable {
     ...
     * integer with fields such as {@link org.pdf4j.saxon.type.SchemaType#DERIVATION_LIST} and {@link org.pdf4j.saxon.type.SchemaType#DERIVATION_EXTENSION}
     *
     ...
     *
     * @return a numeric code representing the derivation method, for example {@link org.pdf4j.saxon.type.SchemaType#DERIVATION_RESTRICTION}
     */
     ...
     *
     * @param derivation the kind of derivation, for example {@link org.pdf4j.saxon.type.SchemaType#DERIVATION_LIST}
     ...
     * @throws org.pdf4j.saxon.type.SchemaException if the derivation is not allowed
     */
     ...
     *         returned by this SequenceIterator will all be of type {@link org.pdf4j.saxon.value.AtomicValue}
     */
     ...
     * @param kind       the node kind whose content is being delivered: {@link org.pdf4j.saxon.type.Type#ELEMENT},
     *                   {@link org.pdf4j.saxon.type.Type#ATTRIBUTE}, or {@link org.pdf4j.saxon.type.Type#DOCUMENT}
