...
public abstract class AtomicValue extends Value implements Item, GroundedValue, ConversionResult {
     ...
     * use {@link #copyAsSubType(org.pdf4j.saxon.type.AtomicType)}
     *
     ...
     * @see org.pdf4j.saxon.value.Cardinality
     */
     ...
     *                  {@link org.pdf4j.saxon.functions.Component}, for example {@link org.pdf4j.saxon.functions.Component#HOURS}
