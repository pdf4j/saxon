 ...
 * To execute the query, it must first be loaded to form an {@link org.pdf4j.saxon.s9api.XQueryEvaluator}.
 *
 ...
 * {@link org.pdf4j.saxon.s9api.XQueryCompiler} class.</p>
 *
 * @since 9.0
 */
public class XQueryExecutable {
    ...
    public ItemType getResultItemType() {
        org.pdf4j.saxon.type.ItemType it =
