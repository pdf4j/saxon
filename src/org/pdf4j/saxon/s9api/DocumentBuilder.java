 ...
 * by calling the factory method {@link org.pdf4j.saxon.s9api.Processor#newDocumentBuilder()}.</p>
 * <p/>
...
public class DocumentBuilder {
     ...
     * by calling the factory method {@link org.pdf4j.saxon.s9api.Processor#newDocumentBuilder()}.
     *
     ...
     * Java method {@link org.pdf4j.saxon.om.NodeInfo#getLineNumber()} </p>
     * <p/>
     ...
     *   <p/>
     *   <p>If the source is an instance of {@link org.pdf4j.saxon.om.NodeInfo} then the subtree rooted at this node
     *   will be copied (applying schema validation if requested) to create a new tree.</p>
     *   <p/>
     *   <p>Saxon also accepts an instance of {@link org.pdf4j.saxon.pull.PullSource}, which can be used to supply
