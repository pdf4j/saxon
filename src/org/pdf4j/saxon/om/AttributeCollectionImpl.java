...
public final class AttributeCollectionImpl implements Attributes, AttributeCollection {
     ...
     * to the parameters of the {@link org.pdf4j.saxon.event.Receiver#attribute(int,int,CharSequence,int,int)}
     ...
     * The bit {@link org.pdf4j.saxon.om.NodeInfo#IS_DTD_TYPE} represents a DTD-derived type.
     */
