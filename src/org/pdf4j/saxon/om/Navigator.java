        ...
        public void advance() {
            ...
            if (children != null) {
                ...
                if (start.hasChildNodes()) {
                    ...
                    if (!forwards) {
                        if (children instanceof org.pdf4j.saxon.expr.ReversibleIterator) {
                            children = (AxisIterator)((org.pdf4j.saxon.expr.ReversibleIterator)children).getReverseIterator();
                        } else {
                            try {
