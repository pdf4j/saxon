...
public interface NodeInfo extends Source, Item, ValueRepresentation {
    ...
    /**
     * Get the kind of node. This will be a value such as {@link org.pdf4j.saxon.type.Type#ELEMENT}
     * or {@link org.pdf4j.saxon.type.Type#ATTRIBUTE}. There are seven kinds of node: documents, elements, attributes,
	 ...
	 * @see org.pdf4j.saxon.om.NamePool#getFingerprint getFingerprint
     * @since 8.4
	 */
    ...
    */
     ...
     *      defined in class {@link org.pdf4j.saxon.om.Axis}
