...
import org.pdf4j.saxon.sort.SortExpression;
import org.pdf4j.saxon.sort.TupleSorter;
...
//                gatherDirectContributingCallees(((IfExpression)kid).getElseExpression(), result);
     ...
     * It is acceptable to supply a {@link org.pdf4j.saxon.value.Closure} to represent a value whose
     ...
     * may be obtained by calling {@link org.pdf4j.saxon.query.XQueryExpression#newController}. This may
     ...
     * (values in {@link org.pdf4j.saxon.om.StandardNames}: all less than 1024)
     * or it will be a constant in class {@link org.pdf4j.saxon.trace.Location}.
     */
