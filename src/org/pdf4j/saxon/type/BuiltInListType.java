...
public class BuiltInListType implements ListType, Serializable {
   ...
   /**
     ...
     *         node. The objects returned by this iterator are of type {@link org.pdf4j.saxon.value.AtomicValue}
     */
...
//        }
    ...
    private static class ListTypeMappingFunction implements MappingFunction {
         ...
         * For details see {@link org.pdf4j.saxon.expr.MappingFunction}
        */
