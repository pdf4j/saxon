...
import org.pdf4j.saxon.event.SaxonLocator;
import org.pdf4j.saxon.event.SourceLocationProvider;
...
public class DOMSender implements SaxonLocator, SourceLocationProvider {
    ...
    * @exception org.pdf4j.saxon.trans.XPathException On any error in the document
    */
