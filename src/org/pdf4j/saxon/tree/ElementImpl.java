...
import org.pdf4j.saxon.event.CopyInformee;
import org.pdf4j.saxon.event.Receiver;
import org.pdf4j.saxon.event.ReceiverOptions;
...
public class ElementImpl extends ParentNodeImpl implements NamespaceResolver {
    ...
    * @throws org.pdf4j.saxon.om.NamespaceException if the prefix has not been declared on this NamespaceList.
    */
