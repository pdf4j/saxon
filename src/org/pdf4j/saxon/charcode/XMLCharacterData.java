...
public class XMLCharacterData {
    ...
    public static boolean isValid10(int i) {
        return i < 65536 ? (data[i]&VALID_10_MASK) != 0 : (UTF16.NONBMP_MIN <= i && i <= UTF16.NONBMP_MAX);
    }
    ...
    public static boolean isValid11(int i) {
        return i < 65536 ? (data[i]&VALID_11_MASK) != 0 : (UTF16.NONBMP_MIN <= i && i <= UTF16.NONBMP_MAX);
    }
    ...
    public static boolean isNCName11(int i) {
        return i < 65536 ? (data[i]&NAME_11_MASK) != 0 : (UTF16.NONBMP_MIN <= i && i <= MAX_XML11_NAME_CHAR);
    }
    ...
    public static boolean isNCNameStart11(int i) {
        return i < 65536 ? (data[i]&NAME_START_11_MASK) != 0 : (UTF16.NONBMP_MIN <= i && i <= MAX_XML11_NAME_CHAR);
    }
