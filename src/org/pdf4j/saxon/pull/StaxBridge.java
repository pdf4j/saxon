...
import org.pdf4j.saxon.expr.ExpressionLocation;
import org.pdf4j.saxon.om.*;
import org.pdf4j.saxon.tinytree.CharSlice;
...
//                        System.err.println("  START: " + reader.getTextStart() + " LENGTH " + reader.getTextLength());
     ...
     * This is a value that can be passed to the {@link org.pdf4j.saxon.event.LocationProvider}
     * held by the {@link org.pdf4j.saxon.event.PipelineConfiguration} to get real location information (line number,
    ...
    private class StaxAttributes implements AttributeCollection {
         ...
         *         to a {@link org.pdf4j.saxon.event.LocationProvider} in order to obtain the
         ...
         *         of bit-settings defined in class {@link org.pdf4j.saxon.event.ReceiverOptions}. The
         *         most interesting of these is {{@link org.pdf4j.saxon.event.ReceiverOptions#DEFAULTED_ATTRIBUTE},
     ...
     *         be an instance of {@link org.pdf4j.saxon.pull.UnparsedEntity}
     */
