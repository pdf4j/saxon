...
import org.pdf4j.saxon.functions.NumberFn;
...
import org.pdf4j.saxon.sort.SortKeyEvaluator;
import org.pdf4j.saxon.sort.SortedIterator;
...
public class XPathExpressionImpl implements XPathExpression, SortKeyEvaluator {
    ...
    */
     ...
     * node must have been set previously using {@link #setContextNode(org.pdf4j.saxon.om.NodeInfo)}.
    ...
    */
     ...
     * must be set previously using {@link #setContextNode(org.pdf4j.saxon.om.NodeInfo)}.
