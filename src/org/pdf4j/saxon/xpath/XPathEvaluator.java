...
import org.pdf4j.saxon.dom.DocumentWrapper;
import org.pdf4j.saxon.dom.NodeWrapper;
...
/**
  ...
  * see {@link org.pdf4j.saxon.sxpath.XPathEvaluator}.</p>
  *
...
public class XPathEvaluator implements XPath {
    ...
    */
     ...
     * documents are built is to use the class {@link org.pdf4j.saxon.AugmentedSource} for any
    ...
    */
     ...
     * which XPath expressions will be executed. Note that a Saxon {@link org.pdf4j.saxon.om.DocumentInfo DocumentInfo}
     * (indeed any {@link org.pdf4j.saxon.om.NodeInfo NodeInfo})
    ...
    public NodeInfo setSource(Source source) throws org.pdf4j.saxon.trans.XPathException {
        if (source instanceof DOMSource) {
            ...
            if (!origin.getConfiguration().isCompatible(config)) {
                throw new org.pdf4j.saxon.trans.XPathException(
    ...
    */
     ...
     * @throws org.pdf4j.saxon.trans.XPathException if the syntax of the expression is wrong, or if it references namespaces,
     * variables, or functions that have not been declared.
     * @deprecated since Saxon 8.9 - use {@link #compile(String)}
    */

    public XPathExpressionImpl createExpression(String expression) throws org.pdf4j.saxon.trans.XPathException {
    ...
    */
     ...
     * @throws org.pdf4j.saxon.type.SchemaException if the schema contained in this document is invalid
    ...
    public XPathExpression compile(String expr) throws XPathExpressionException {
        ...
        } catch (org.pdf4j.saxon.trans.XPathException e) {
