...
public class DynamicQueryContext {
     ...
     * {@link org.pdf4j.saxon.Configuration#buildDocument buildDocument}
    ...
    /**
     * Get the date and time set previously using {@link #setCurrentDateTime(org.pdf4j.saxon.value.DateTimeValue)}
